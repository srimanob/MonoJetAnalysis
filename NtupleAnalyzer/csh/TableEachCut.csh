...
echo "|   *Selection*       |  *WJets*  |  *Zinv*   |  *ZJets*  |  *TTbar*  |  *SingleT*  | *QCD*  |  *Total Bckg*  |  *Data*  |  *MD2D2*  |   *DM-t*  | "


echo -n "|Pre Selection        " 
Table MetLep1 2.5  wjets_AnaMonoJet_0  znunu_table_0  zjets_AnaMonoJet_0 ttbar_AnaMonoJet_0   sint_table_0  qcd_table_0  data_table_0    md2d2_AnaMonoJet_0    dmt_AnaMonoJet_0  
echo " " 
echo -n "|PFMet+mu >200 GeV    " 
Table MetLep1 2.5  wjets_AnaMonoJet_1  znunu_table_1  zjets_AnaMonoJet_1 ttbar_AnaMonoJet_1   sint_table_1  qcd_table_1  data_table_1    md2d2_AnaMonoJet_1    dmt_AnaMonoJet_1  
echo " " 
echo -n "|Noise Clean          " 
Table MetLep1 2.5  wjets_AnaMonoJet_2  znunu_table_2  zjets_AnaMonoJet_2 ttbar_AnaMonoJet_2   sint_table_2  qcd_table_2  data_table_2    md2d2_AnaMonoJet_2    dmt_AnaMonoJet_2  
echo " " 
echo -n "|Leading Jet Cut      " 
Table MetLep1 2.5  wjets_AnaMonoJet_3  znunu_table_3  zjets_AnaMonoJet_3 ttbar_AnaMonoJet_3   sint_table_3  qcd_table_3  data_table_3    md2d2_AnaMonoJet_3    dmt_AnaMonoJet_3  
echo " "
echo -n "|NJet Cut             " 
Table MetLep1 2.5  wjets_AnaMonoJet_4  znunu_table_4  zjets_AnaMonoJet_4 ttbar_AnaMonoJet_4   sint_table_4  qcd_table_4  data_table_4    md2d2_AnaMonoJet_4    dmt_AnaMonoJet_4  
echo " "
echo -n "|DPhi(jet1, jet2)<2.5 " 
Table MetLep1 2.5  wjets_AnaMonoJet_5  znunu_table_5  zjets_AnaMonoJet_5 ttbar_AnaMonoJet_5   sint_table_5  qcd_table_5  data_table_5    md2d2_AnaMonoJet_5    dmt_AnaMonoJet_5  
echo " "
echo -n "|Muon Isolation       " 
Table MetLep1 2.5  wjets_AnaMonoJet_6  znunu_table_6  zjets_AnaMonoJet_6 ttbar_AnaMonoJet_6   sint_table_6  qcd_table_6  data_table_6    md2d2_AnaMonoJet_6    dmt_AnaMonoJet_6  
echo " "
echo -n "|PF e, mu pt<10 GeV   " 
Table MetLep1 2.5  wjets_AnaMonoJet_7  znunu_table_7  zjets_AnaMonoJet_7 ttbar_AnaMonoJet_7   sint_table_7  qcd_table_7  data_table_7    md2d2_AnaMonoJet_7    dmt_AnaMonoJet_7  
echo " "
echo -n "|TIV>0.0 1            " 
Table MetLep1 2.5  wjets_AnaMonoJet_8  znunu_table_8  zjets_AnaMonoJet_8 ttbar_AnaMonoJet_8   sint_table_8  qcd_table_8  data_table_8    md2d2_AnaMonoJet_8    dmt_AnaMonoJet_8  
echo " "
echo -n "|PFMet+mu >250 GeV    " 
Table MetLep1 2.5  wjets_AnaMonoJet_9  znunu_table_9  zjets_AnaMonoJet_9 ttbar_AnaMonoJet_9   sint_table_9  qcd_table_9  data_table_9    md2d2_AnaMonoJet_9    dmt_AnaMonoJet_9  
echo " "
echo -n "|PFMet+mu >300 GeV    " 
Table MetLep1 2.5  wjets_AnaMonoJet_10 znunu_table_10 zjets_AnaMonoJet_10 ttbar_AnaMonoJet_10 sint_table_10 qcd_table_10  data_table_10  md2d2_AnaMonoJet_10   dmt_AnaMonoJet_10 
echo " "
echo -n "|PFMet+mu >350 GeV    " 
Table MetLep1 2.5  wjets_AnaMonoJet_11 znunu_table_11 zjets_AnaMonoJet_11 ttbar_AnaMonoJet_11 sint_table_11 qcd_table_11  data_table_11  md2d2_AnaMonoJet_11   dmt_AnaMonoJet_11 
echo " "
echo -n "|PFMet+mu >400 GeV    " 
Table MetLep1 2.5  wjets_AnaMonoJet_12 znunu_table_12 zjets_AnaMonoJet_12 ttbar_AnaMonoJet_12 sint_table_12 qcd_table_12  data_table_12  md2d2_AnaMonoJet_12   dmt_AnaMonoJet_12 
