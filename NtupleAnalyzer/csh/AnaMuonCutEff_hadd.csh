...
Merge  dPhi_MetMu_Jet1  "#Delta#phi(Jet_{1}, |#vecE^{miss}_{T}+#vecp_{T}(#mu)|))"   "Events / 0.1"    AnaMuonCutEff_0_4 "Z#rightarrow#nu#nu" AnaMuonCutEff_0_3 "W#rightarrowl#nu" AnaMuonCutEff_0_2 "t#bar{t}" AnaMuonCutEff_0_1 "QCD"  AnaMuonCutEff_0_0 "Z#rightarrowl^{+}l^{-}" data_0 "Data"
Merge  dPhi_MetMu_Jet2  "#Delta#phi(Jet_{2}, |#vecE^{miss}_{T}+#vecp_{T}(#mu)|))"   "Events / 0.1"    AnaMuonCutEff_0_4 "Z#rightarrow#nu#nu" AnaMuonCutEff_0_3 "W#rightarrowl#nu" AnaMuonCutEff_0_2 "t#bar{t}" AnaMuonCutEff_0_1 "QCD"  AnaMuonCutEff_0_0 "Z#rightarrowl^{+}l^{-}" data_0 "Data"
...
Merge  MetMu1   "|#vecE^{miss}_{T}+#vecp_{T}(#mu)| [GeV] "             "Events / 25 GeV"              AnaMuonCutEff_0_4 "Z#rightarrow#nu#nu" AnaMuonCutEff_0_3 "W#rightarrowl#nu" AnaMuonCutEff_0_2 "t#bar{t}" AnaMuonCutEff_0_1 "QCD"  AnaMuonCutEff_0_0 "Z#rightarrowl^{+}l^{-}" data_0 "Data" 
Merge  MetMuThrs1 "|#vecE^{miss}_{T}+#vecp_{T}(#mu)| Threshold [GeV]"  "Integrated Events / 25 GeV"   AnaMuonCutEff_0_4 "Z#rightarrow#nu#nu" AnaMuonCutEff_0_3 "W#rightarrowl#nu" AnaMuonCutEff_0_2 "t#bar{t}" AnaMuonCutEff_0_1 "QCD"  AnaMuonCutEff_0_0 "Z#rightarrowl^{+}l^{-}" data_0 "Data"
Merge  MetMu2   "|#vecE^{miss}_{T}+#vecp_{T}(#mu)| [GeV] "             "Events / 25 GeV"              AnaMuonCutEff_0_4 "Z#rightarrow#nu#nu" AnaMuonCutEff_0_3 "W#rightarrowl#nu" AnaMuonCutEff_0_2 "t#bar{t}" AnaMuonCutEff_0_1 "QCD"  AnaMuonCutEff_0_0 "Z#rightarrowl^{+}l^{-}" data_0 "Data" 
Merge  MetMu3   "|#vecE^{miss}_{T}+#vecp_{T}(#mu)| [GeV] "             "Events / 25 GeV"              AnaMuonCutEff_0_4 "Z#rightarrow#nu#nu" AnaMuonCutEff_0_3 "W#rightarrowl#nu" AnaMuonCutEff_0_2 "t#bar{t}" AnaMuonCutEff_0_1 "QCD"  AnaMuonCutEff_0_0 "Z#rightarrowl^{+}l^{-}" data_0 "Data" 
Merge  MetMuThrs2 "|#vecE^{miss}_{T}+#vecp_{T}(#mu)| Threshold [GeV]"  "Integrated Events / 25 GeV"   AnaMuonCutEff_0_4 "Z#rightarrow#nu#nu" AnaMuonCutEff_0_3 "W#rightarrowl#nu" AnaMuonCutEff_0_2 "t#bar{t}" AnaMuonCutEff_0_1 "QCD"  AnaMuonCutEff_0_0 "Z#rightarrowl^{+}l^{-}" data_0 "Data"
...
Merge  dPhi_MetMu_Jet1  "#Delta#phi(Jet_{1}, |#vecE^{miss}_{T}+#vecp_{T}(#mu)|)"  "Events / 0.1"        AnaMuonCutEff_4_4 "Z#rightarrow#nu#nu" AnaMuonCutEff_4_3 "W#rightarrowl#nu" AnaMuonCutEff_4_2 "t#bar{t}" AnaMuonCutEff_4_1 "QCD"  AnaMuonCutEff_4_0 "Z#rightarrowl^{+}l^{-}" data_4 "Data"
Merge  dPhi_MetMu_Jet2 "#Delta#phi(Jet_{2}, |#vecE^{miss}_{T}+#vecp_{T}(#mu)|)" "Events / 0.1"          AnaMuonCutEff_4_4 "Z#rightarrow#nu#nu" AnaMuonCutEff_4_3 "W#rightarrowl#nu" AnaMuonCutEff_4_2 "t#bar{t}" AnaMuonCutEff_4_1 "QCD"  AnaMuonCutEff_4_0 "Z#rightarrowl^{+}l^{-}" data_4 "Data"
...
Merge  MetMu1   "|#vecE^{miss}_{T}+#vecp_{T}(#mu)| [GeV] "             "Events / 25 GeV"    AnaMuonCutEff_5_4 "Z#rightarrow#nu#nu" AnaMuonCutEff_5_3 "W#rightarrowl#nu" AnaMuonCutEff_5_2 "t#bar{t}" AnaMuonCutEff_5_1 "QCD"  AnaMuonCutEff_5_0 "Z#rightarrowl^{+}l^{-}" data_5 "Data" 
Merge  MetMuThrs1  "|#vecE^{miss}_{T}+#vecp_{T}(#mu)| Threshold [GeV]" "Integrated Events / 25 GeV"    AnaMuonCutEff_5_4 "Z#rightarrow#nu#nu" AnaMuonCutEff_5_3 "W#rightarrowl#nu" AnaMuonCutEff_5_2 "t#bar{t}" AnaMuonCutEff_5_1 "QCD"  AnaMuonCutEff_5_0 "Z#rightarrowl^{+}l^{-}" data_5 "Data"
Merge  MetMu2   "|#vecE^{miss}_{T}+#vecp_{T}(#mu)| [GeV] "             "Events / 25 GeV"    AnaMuonCutEff_5_4 "Z#rightarrow#nu#nu" AnaMuonCutEff_5_3 "W#rightarrowl#nu" AnaMuonCutEff_5_2 "t#bar{t}" AnaMuonCutEff_5_1 "QCD"  AnaMuonCutEff_5_0 "Z#rightarrowl^{+}l^{-}" data_5 "Data" 
Merge  MetMu3   "|#vecE^{miss}_{T}+#vecp_{T}(#mu)| [GeV] "             "Events / 25 GeV"    AnaMuonCutEff_5_4 "Z#rightarrow#nu#nu" AnaMuonCutEff_5_3 "W#rightarrowl#nu" AnaMuonCutEff_5_2 "t#bar{t}" AnaMuonCutEff_5_1 "QCD"  AnaMuonCutEff_5_0 "Z#rightarrowl^{+}l^{-}" data_5 "Data" 
Merge  MetMuThrs2 "|#vecE^{miss}_{T}+#vecp_{T}(#mu)| Threshold [GeV]"  "Integrated Events / 25 GeV"    AnaMuonCutEff_5_4 "Z#rightarrow#nu#nu" AnaMuonCutEff_5_3 "W#rightarrowl#nu" AnaMuonCutEff_5_2 "t#bar{t}" AnaMuonCutEff_5_1 "QCD"  AnaMuonCutEff_5_0 "Z#rightarrowl^{+}l^{-}" data_5 "Data"
